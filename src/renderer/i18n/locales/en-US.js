export default {
  ...
  INTRODUCTION: {
    ...
    DUTY: {
      ...
      WARNING: {
        ...
        CANNOT_RESTORE: 'lost passwords, passphrases or stolen funds cannot be restored by the delegates, CRIPTOSISTEMA.io team, or anyone else'
      },
    ...
    RESPONSIBILITY: {
      ...
      STORAGE: {
        EXPLANATION: 'The {PASSPHRASE} of each wallet address is able to sign transactions and move funds. This means if your computer dies but you have your passphrase, you can still access your funds. The CRIPTOSISTEMA Desktop Wallet has an additional feature that lets you set an {ENCRYPTED} as well, for easier management. If your computer dies, you cannot use the encrypted password to access your funds from a different machine. {NEED}.',
      ...
      BACKUP: {
        ...
        OPTIONS: 'You can write it down on thick paper and store multiple copies in secure locations. You can also store it on an encrypted flash drive. Alternatively, you can use a Ledger Nano S USB hardware device, available at Ledger.com, to store and access your funds and the CRIPTOSISTEMA Desktop Wallet. You can plug your Ledger Nano S into your computer and access the CRIPTOSISTEMA blockchain without needing to enter your passphrase.'
      },
    ...
    TURN: {
      TITLE: 'Your Turn',
      KNOWLEDGE: 'Now, armed with the knowledge of how important it is to keep your passphrases safe, you are ready to claim your financial autonomy with the CRIPTOSISTEMA Desktop Wallet.',
      SUPPORT: 'CRIPTOSISTEMA is an open-source ecosystem and if you need assistance, the CRIPTOSISTEMA community and team is here to help. Create a post on reddit.CRIPTOSISTEMA.io, or join the real-time chat system at slack.CRIPTOSISTEMA.io.',
      CONCLUSION: 'Everyone here on the CRIPTOSISTEMA.io team hopes you enjoy using the CRIPTOSISTEMA Desktop Wallet to participate in the blockchain revolution!'
    }
  },
  ...
  LEDGER: {
    NEEDS_UPDATE: 'Ledger update available! Please update the CRIPTOSISTEMA app via Ledger Live to send transactions on this network'
  },
  ...
  APP_FOOTER: {
    TEXT: 'Made with ♥ by CRIPTOSISTEMA'
  },
  ...
  PAGES: {
    ...
    PLUGIN_MANAGER: {
      ...
      GRANTS: 'Funded by CRIPTOSISTEMA Grants',
      MENU: 'Menu',
      BANNER: {
      ...
      DISCLAIMER: '<b>Disclaimer:</b> The availability of this plugin in the CRIPTOSISTEMA Desktop Wallet does not mean that either CRIPTOSISTEMA.io or CRIPTOSISTEMA SCIC is directly involved in the development or affiliated with the developer providing this plugin. By installing it on your wallet, you assume every responsibility.',
    ...
    PROFILE_EDITION: {
      ...
      ADVANCED_MODE: {
        DECLINE: 'I Decline',
        ACCEPT: 'I Accept',
        QUESTION: 'By enabling Advanced Mode you hereby assume the risk associated with downloading files and installing said files from a direct URL link. The aforementioned links have neither been tested nor approved by CRIPTOSISTEMA.io and CRIPTOSISTEMA SCIC. We make no warranties, expressed or implied, as to the sustainability, availability, security, of these URLs. We are not responsible for any consequences which may occur from downloading, viewing, or installing files directly from a URL or feature that is activated via toggling on Advanced Mode. CRIPTOSISTEMA.io and CRIPTOSISTEMA SCIC shall bear no liability for any loss suffered by users who bypass certain measures by toggling on Advanced Mode. By clicking “I Accept” you acknowledge that enabling Advanced Mode may result in you downloading, viewing, or installing content that may have bugs, glitches, lack of functionality, or can cause damage to your machine or result in the loss of data.',
    ...
    WALLET_EXCHANGE: {
      CHANGELLY_TERMS: {
        TITLE: 'Purchase {ticker} directly within CRIPTOSISTEMA Desktop Wallet with our Changelly integration',
